...
public class AdminManageexercise extends AppCompatActivity {
...
TextView AdminManageExercises;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdminManageExercises=findViewById(R.id.ManageDoctorExercisesTitle);
        AdminManageExercises.setText("Admin Manage Exercises ");
        adminId = getIntent().getIntExtra("admin_id", -1);
        ToastUtil.show(this, String.valueOf(adminId), 1/3);
...
//        outputView = findViewById(R.id.output);
                ...
                new ExerciseAdapter.OnExerciseActionListener() {
                    ...
                    public void onEdit(Exercise exercise) {
                        showEditExerciseDialog(
                                AdminManageexercise.this,  // context
                                exercise,
                                true,  // isAdmin = true
                                () -> adapter.notifyDataSetChanged()  // refresh the RecyclerView after editing
                        );
                    }
    ...
    private void setupButtons() {
        ...
        btnAssignExercises.setOnClickListener(view -> {
            Intent intent = new Intent(this, AdminAssignExerciseActivity.class);
            intent.putExtra("admin_id", adminId);
            startActivity(intent);
        });

        btnAddExercises.setOnClickListener(view -> {
            Intent intent = new Intent(this, AdminAddExerciseActivity.class);
            intent.putExtra("admin_id", adminId);
            startActivity(intent);
        });
    }
    ...
    private void fetchExercises() {
        String url = ApiConfig.GET_EXERCISES_BY_ADMIN + "?admin_id=" + adminId;
...
//            intent.putExtra("admin_id", getIntent().getIntExtra("admin_id", -1)); // pass back user ID
