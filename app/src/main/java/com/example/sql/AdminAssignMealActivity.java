...
public class AdminAssignMealActivity extends AppCompatActivity {
   ...
   int adminId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdminManageExercises=findViewById(R.id.ManageAssignMealsTitle);

        AdminManageExercises.setText("Admin Assign Meals ");
...
//    }
    ...
    private void fetchMeals(int adminId) {
        mealList.clear();
        String url = ApiConfig.GET_MEALS_ASSIGN_ADMIN + "?admin_id=" + adminId;
    ...
    private void assignSelectedMeals() {
        ...
        String url = ApiConfig.ADMIN_ASSIGN_MEAL;
