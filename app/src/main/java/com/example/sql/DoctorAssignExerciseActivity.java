...
public class DoctorAssignExerciseActivity extends AppCompatActivity {
...
//    }
private void fetchExercises() {
    String url = ApiConfig.BASE_URL+"get_exercises_with_doctor_id.php" + "?doctor_id=" + doctorId;
    ...
    private void assignSelectedExercises() {
        ...
        String url = ApiConfig.ASSIGN_EXERCISES_URL;
