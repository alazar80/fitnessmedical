...
//        voiceToggle = findViewById(R.id.voiceToggle);
        ...
        goalSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                sendGoalToServer(userId, selectedGoal);
            }
        });
        ...
        languageSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!sel.equals(currLang)) {
                    LocaleHelper.setLocale(SettingsActivity.this, sel);
...
//        });
    ...
    private void sendGoalToServer(int userId, String newGoal) {
        String urlPost = ApiConfig.UPDATE_USERS_GOAL;
        RequestQueue queue = Volley.newRequestQueue(this);
