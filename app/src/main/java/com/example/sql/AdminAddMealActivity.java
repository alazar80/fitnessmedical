...
public class AdminAddMealActivity extends AppCompatActivity {
...
TextView AdminManageExercises;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdminManageExercises=findViewById(R.id.ManageAddMealsTitle);

        AdminManageExercises.setText("Admin Add Meals ");
    ...
    private void submitMeal() {
        ...
        params.put("admin_id", String.valueOf(getIntent().getIntExtra("admin_id", -1)));
