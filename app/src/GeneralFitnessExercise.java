...
public class GeneralFitnessExercise extends AppCompatActivity {
    ...
    private final String URL = ApiConfig.GET_EXERCISE_BY_USER_FOR_HOME; // Change this!
        ...
        StringRequest request = new StringRequest(Request.Method.POST, URL,
                response -> {
                    try {
                        ...
                        if (!success) {
                            ToastUtil.show(GeneralFitnessExercise.this, "Failed to fetch exercises", 1/3);
                            return;
                        }
...
//                        ToastUtil.show(newnew.this, message, 1/3);
                        ...
                        ToastUtil.show(GeneralFitnessExercise.this, "Parse error", 1/3);
                    }
                },
                error -> {
                    Log.e("EXERCISE_REQUEST", "Volley error", error);
                    ToastUtil.show(GeneralFitnessExercise.this, "Network error", 1/3);
                }
        ) {
            @Override
